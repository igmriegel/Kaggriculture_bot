...
## Sprint 2: LeaderV10.1 (Market Speculation) - [TODO]
**Objetivo:** Permitir retenção de inventário contra quedas bruscas de preço.
- [ ] Adicionar `speculation_hold_threshold` e `speculation_min_liquidity` ao `V10Config`.
- [ ] Atualizar o módulo `_sales` na engine.
- [ ] Lógica: Se o preço de um crop cair abaixo do limite e houver caixa para segurar a operação, reter no inventário.
- [ ] Escrever teste unitário para garantir que crops valiosos não sejam vendidos em baixa.
